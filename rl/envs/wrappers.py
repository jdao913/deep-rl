...
class SymmetricEnv:    
    ...
    # where the clocks are located need to be inputted. Can't just swap clock indices, this would only shift
    # clock by quarter of phase, but need to actually shift each by half a phase
